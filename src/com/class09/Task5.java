...
public class Task5 {
	...
	public static void main(String[] args) {
		 ...
		 *  After every guess input, the program tells the user whether their number was too 
		 *  large or too small. The program will keep asking the user to enter the number until 
		 *  he finds the correct number. When the correct answer is found the system should 
